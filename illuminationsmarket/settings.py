"""
Django settings for illuminationsmarket project.
...
ROOT_URLCONF = 'illuminationsmarket.urls'
...
WSGI_APPLICATION = 'illuminationsmarket.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'apps/first_app/static')
# STATIC_URL = '/static/'
